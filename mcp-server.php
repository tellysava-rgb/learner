...
function mcp_tools_schema(): array {
    return [
        ...
        [
            'name'        => 'update_card',
            'description' => 'Ändert einzelne Felder einer bestehenden Karte (von list_cards). Nur die übergebenen Felder werden geändert, alle anderen bleiben unverändert. sprache_a_begriff/sprache_b_begriff dürfen nicht leer sein falls angegeben. Gleiche Feld-Regeln wie bei add_cards (Dialekt-Konsistenz, Lautschrift-Stil). Bei phonetik_b gilt ebenfalls: muss in den Lesekonventionen der Muttersprache der lernenden Person geschrieben sein — bei Unklarheit vorher explizit erfragen, nicht stillschweigend Deutsch annehmen. WICHTIG: dem User vor dem Aufruf immer zeigen, was sich pro Karte ändert (alt → neu), und Bestätigung abwarten.',
            'inputSchema' => [
                'type'       => 'object',
                'properties' => [
                    'card_id'           => ['type' => 'integer', 'description' => 'ID der Karte (card_id von list_cards)'],
                    'sprache_a_begriff' => ['type' => 'string', 'maxLength' => 500, 'description' => 'Neuer Begriff Sprache A (optional, nicht leer falls angegeben). Gleiche Gross-/Kleinschreibungs-Regel wie bei add_cards, falls Deutsch.'],
                    'sprache_b_begriff' => ['type' => 'string', 'maxLength' => 500, 'description' => 'Neuer Begriff Sprache B (optional, nicht leer falls angegeben). Gleiche Gross-/Kleinschreibungs-Regel wie bei add_cards, falls Deutsch.'],
                    ...
                    'phonetik_b'        => ['type' => 'string', 'maxLength' => 200, 'description' => 'Neue Lautschrift (optional, leerer String löscht sie), gleicher Stil wie bei add_cards — Lesekonventionen der Muttersprache der lernenden Person, bei Unklarheit vorher erfragen'],
                ],
                'required' => ['card_id'],
            ],
        ],
