        ...
        <div class="accordion-item">
            ...
            <div id="gb-pin" class="accordion-collapse collapse">
                <div class="accordion-body">
                    ...
                    <ul class="mb-2">
                        <li><strong>Umschaltbar an drei Stellen:</strong> auf der Kartenübersicht über das Pin-Icon in der Kartenansicht (Augen-Icon "Karte ansehen"), oder direkt während einer laufenden Leitner- oder Drill-Session über dasselbe Symbol oben links auf der Lernkarte — ein Klick schaltet sofort um, ohne die Session zu unterbrechen.</li>
